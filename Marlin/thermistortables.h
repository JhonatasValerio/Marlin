...
// Termistor Sethi B=4000
// Retirado do grupo reprapbr - tabela criada pelo Alex Borro.
// Os valores calibrados estão marcados com "Thermocouple"
   {1*OVERSAMPLENR, 722},
   {21*OVERSAMPLENR, 306},
   {41*OVERSAMPLENR, 256},
   {46*OVERSAMPLENR, 240},   //Thermocouple
   {51*OVERSAMPLENR, 235},   //Thermocouple
   {56*OVERSAMPLENR, 230},   //Thermocouple
   {61*OVERSAMPLENR, 225},   //Thermocouple
   {67*OVERSAMPLENR, 220},   //Thermocouple
   {81*OVERSAMPLENR, 210},   //Thermocouple
   {98*OVERSAMPLENR, 200},   //Thermocouple
   {119*OVERSAMPLENR, 190},  //Thermocouple
   {144*OVERSAMPLENR, 180},  //Thermocouple
   {176*OVERSAMPLENR, 170},  //Thermocouple
   {213*OVERSAMPLENR, 160},  //Thermocouple
   {250*OVERSAMPLENR, 150},  //Thermocouple
   {261*OVERSAMPLENR, 146},
   {281*OVERSAMPLENR, 142},
   {301*OVERSAMPLENR, 138},
   {321*OVERSAMPLENR, 134},
   {341*OVERSAMPLENR, 131},
   {361*OVERSAMPLENR, 128},
   {381*OVERSAMPLENR, 125},
   {401*OVERSAMPLENR, 121},
   {421*OVERSAMPLENR, 119},
   {441*OVERSAMPLENR, 116},
   {461*OVERSAMPLENR, 113},
   {481*OVERSAMPLENR, 110},
   {501*OVERSAMPLENR, 107},
   {521*OVERSAMPLENR, 105},
   {541*OVERSAMPLENR, 102},
   {561*OVERSAMPLENR, 100},
   {581*OVERSAMPLENR, 97},
   {601*OVERSAMPLENR, 94},
   {621*OVERSAMPLENR, 92},
   {641*OVERSAMPLENR, 89},
